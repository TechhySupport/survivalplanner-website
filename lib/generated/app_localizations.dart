...
abstract class AppLocalizations {
  ...
  /// No description provided for @infantry.
  ///
  /// In en, this message translates to:
  /// **'Infantry'**
  String get infantry;

  /// No description provided for @marksmen.
  ///
  /// In en, this message translates to:
  /// **'Marksmen'**
  String get marksmen;

  /// No description provided for @lancers.
  ///
  /// In en, this message translates to:
  /// **'Lancers'**
  String get lancers;
  ...
  /// No description provided for @addMoreTroops.
  ///
  /// In en, this message translates to:
  /// **'Add more troops'**
  String get addMoreTroops;

  /// No description provided for @troopsTitle.
  ///
  /// In en, this message translates to:
  /// **'Troops'**
  String get troopsTitle;

  /// No description provided for @totalTroops.
  ///
  /// In en, this message translates to:
  /// **'Total Troops'**
  String get totalTroops;
  ...
  /// No description provided for @bearTrapTroopsTitle.
  ///
  /// In en, this message translates to:
  /// **'Bear Trap Troops'**
  String get bearTrapTroopsTitle;

  /// No description provided for @crazyJoeTroopsTitle.
  ///
  /// In en, this message translates to:
  /// **'Crazy Joe Troops'**
  String get crazyJoeTroopsTitle;

  /// No description provided for @troopTrainingCalculatorTitle.
  ///
  /// In en, this message translates to:
  /// **'Troop Training Calculator'**
  String get troopTrainingCalculatorTitle;

  /// No description provided for @heliosCalculatorTitle.
  ///
  /// In en, this message translates to:
  /// **'Helios Calculator'**
  String get heliosCalculatorTitle;
